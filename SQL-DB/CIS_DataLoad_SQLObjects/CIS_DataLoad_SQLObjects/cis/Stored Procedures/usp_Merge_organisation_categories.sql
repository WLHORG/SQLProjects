CREATE PROCEDURE [cis].[usp_Merge_organisation_categories]
AS 
BEGIN
...
MERGE cis.organisation_categories  AS t
USING cis_delta.organisation_categories  AS s 
...
WHEN MATCHED 
  ...
  BEGIN CATCH
	...
	SELECT 'cis.organisation_categories' as TableName, getdate() as LoadDate, 
