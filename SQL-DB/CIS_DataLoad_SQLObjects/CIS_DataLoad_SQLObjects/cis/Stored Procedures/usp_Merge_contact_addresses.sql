CREATE PROCEDURE [cis].[usp_Merge_contact_addresses]
AS 
BEGIN
...
MERGE cis.contact_addresses AS t
USING cis_delta.contact_addresses AS s 
...
WHEN MATCHED 
  ...
  BEGIN CATCH
	...
	SELECT 'cis.contact_addresses' as TableName, getdate() as LoadDate, 
