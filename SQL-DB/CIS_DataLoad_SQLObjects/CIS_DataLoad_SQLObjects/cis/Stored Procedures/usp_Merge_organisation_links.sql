CREATE PROCEDURE [cis].[usp_Merge_organisation_links]
AS 
BEGIN
...
MERGE cis.organisation_links  AS t
USING cis_delta.organisation_links  AS s 
ON (t.[organisation_number_1] = s.[organisation_number_1]) 
...
WHEN MATCHED 
	...
	t.[organisation_number_1] = s.[organisation_number_1]
  ...
  BEGIN CATCH
	...
	SELECT 'cis.organisation_links' as TableName, getdate() as LoadDate, 
